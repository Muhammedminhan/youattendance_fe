    ...
    <>
      <nav className="sidebar">
        ...
        <NavLink className={navLinkClass} to="/" end>
          <span className="nav-ico" style={{background:'linear-gradient(135deg,#6366f1,#4f46e5)',boxShadow:'0 3px 10px rgba(99,102,241,.32)'}}>
        ...
        <NavLink className={navLinkClass} to="/leave-records">
          <span className="nav-ico" style={{background:'linear-gradient(135deg,#3b82f6,#2563eb)',boxShadow:'0 3px 10px rgba(59,130,246,.32)'}}>
        ...
        <NavLink className={navLinkClass} to="/leave-reports">
          <span className="nav-ico" style={{background:'linear-gradient(135deg,#f59e0b,#d97706)',boxShadow:'0 3px 10px rgba(245,158,11,.32)'}}>
        ...
        <NavLink className={navLinkClass} to="/employees">
          <span className="nav-ico" style={{background:'linear-gradient(135deg,#10b981,#059669)',boxShadow:'0 3px 10px rgba(16,185,129,.32)'}}>
        ...
        <NavLink className={navLinkClass} to="/holidays">
          <span className="nav-ico" style={{background:'linear-gradient(135deg,#ec4899,#db2777)',boxShadow:'0 3px 10px rgba(236,72,153,.32)'}}>
